...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng poblado = new LatLng(6.25185, -75.56360);
        LatLng laureles = new LatLng(6.25186, -75.56361);
        LatLng norte = new LatLng(6.25187, -75.56362);
        LatLng centro = new LatLng(6.25188, -75.56363);
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(medellin,18));
