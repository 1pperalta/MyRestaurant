...
public class ProductoPlatosActivity extends ListActivity {
    ...
    private void setData() {
        ...
        productoActual1.imagenProducto = R.drawable.macaquinho;
        ...
        productoActual2.imagenProducto = R.drawable.barreado;
        ...
        productoActual3.imagenProducto = R.drawable.frijolada;
    ...
    public static class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View vista, ViewGroup arg2) {
            ...
            ImageView imgProducto = (ImageView) view.findViewById(R.id.imageView8);
            imgProducto.setImageDrawable(myContext.getResources().getDrawable(arregloProductos.get(position).imagenProducto));
            ...
            TextView nombreIngredientes = (TextView) view.findViewById(R.id.Ingredientes);
            nombreIngredientes.setText(arregloProductos.get(position).ingredientesProducto);
